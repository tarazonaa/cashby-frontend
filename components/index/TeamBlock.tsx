  ...
  const CreateTeamMember = (
    ...
    return (
      <div className="Bubble">
        <Image alt="coso" src={PersonalImg} />
        ...
        <div className="membersSocials">
          ...
          {/* <div
            className="facebookBox svgBox"
            onClick={() => window.open(SocialsUrls.facebook, "_blank")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
  ...
  return (
    <section className="TeamBlock">
      ...
      <div className="membersContainer">
        {CreateTeamMember("Jesús Muñoz", img, {
        ...
        {CreateTeamMember("Adrián Hernandez", img, {
          instagram: "",
          twitter: "",
          linkedin: "",
        })}
        {CreateTeamMember("Ismael Muñoz", Isma, {
