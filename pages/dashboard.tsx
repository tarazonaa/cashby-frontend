  ...
  return (
    <div className="DashboardPage" id="LinkPage">
      {transversalData.loggedIn ? (
          ...
          >
            <div className="textBox">
              ...
              <p>
                ...
                platform as well as designing and developing the connections
                needed for the process of NFT minting. Nevertheless you can
                still connect your phantom wallet with our site as well as sign
                up for our community so that we can send you an email with our
                updates
              </p>
            </div>
        ...
        >
          <h1>Non Authorized Access, redirecting...</h1>
        </div>
      )}
    </div>
  );
