...
function Zuckerberg({ ...props }: JSX.IntrinsicElements["group"]) {
  const group = useRef<THREE.Group | any>();
  // @ts-ignore
  const { nodes } = useGLTF("/gltfModels/Zuckerberg.gltf") as GLTFResult;
...
useGLTF.preload("/gltfModels/Zuckerberg.gltf");
