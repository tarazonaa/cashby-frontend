...
function RichardBranson({ ...props }: JSX.IntrinsicElements["group"]) {
  const group = useRef<THREE.Group | any>();
  // @ts-ignore
  const { nodes, geometry } = useGLTF(
    "/gltfModels/RichardBranson.gltf"
  ) as GLTFResult;
...
useGLTF.preload("/gltfModels/RichardBranson.gltf");

export default RichardBranson;
