...
function JackMa({ ...props }: JSX.IntrinsicElements["group"]) {
  const group = useRef<THREE.Group | any>();
  // @ts-ignore
  const { nodes, geometry } = useGLTF("/gltfModels/JackMa.gltf") as GLTFResult;
...
useGLTF.preload("/gltfModels/JackMa.gltf");

export default JackMa;
